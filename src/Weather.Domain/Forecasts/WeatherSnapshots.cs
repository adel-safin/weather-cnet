...
/// <summary>Ответ эндпоинта текущей погоды</summary>
public sealed record CurrentWeatherSnapshot(WeatherLocation Location, CurrentWeather Current);

/// <summary>Ответ эндпоинта прогноза - провайдер отдаёт вместе с прогнозом и текущую погоду, что позволяет собрать экран даже при недоступности отдельного эндпоинта current</summary>
