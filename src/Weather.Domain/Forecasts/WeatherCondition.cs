...
/// <summary>Погодное явление: текстовое описание, иконка и код провайдера</summary>
/// <param name="Text">Локализованное описание, например «Солнечно»</param>
/// <param name="IconUrl">Абсолютный URL иконки - провайдер отдаёт protocol-relative адрес, приведение к абсолютному - забота слоя инфраструктуры</param>
